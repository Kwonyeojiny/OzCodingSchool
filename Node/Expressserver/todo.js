...
const updateTodo = newTodo => {
  return axios.put('http://localhost:3000', newTodo).then(res => console.log(res.data));
};

// Delete -> 서버의 Todo 정보를 삭제할 때
const deleteTodo = id => {
  return axios.delete('http://localhost:3000', { data: id }).then(res => console.log(res.data));
};
